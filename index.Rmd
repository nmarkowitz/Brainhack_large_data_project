...
```{r pressure, echo=FALSE, fig.cap="This table displays what types of professionals are utlizing fMRI data for clinical usage. It may be assummed not all backgrounds are trained fully navigating and interpreting large MRI databases.", out.width = '100%'}
...
[Large Data Tree Template](BIDS_Tree_Template_Horizontal.html)
\
\
\
\
